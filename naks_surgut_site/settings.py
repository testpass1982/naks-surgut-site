"""
Django settings for naks_surgut_site project.
...
SECRET_KEY = 't6ra_-uz0wq*-p656#%l8e9z6ylixb+_j=8joh6_4=l1$ubz$b'
...
ROOT_URLCONF = 'naks_surgut_site.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mainapp.context_processors.document_categories',
                'mainapp.context_processors.service_descriptions',
            ],
        },
    },
]

WSGI_APPLICATION = 'naks_surgut_site.wsgi.application'
